...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Stage 3 Records</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    //get the total number of pages for pagination
          ...
          $sql_counter ="SELECT COUNT(*) AS total_records  FROM nominal_roll";
       ...
       //ceil() rounds up decimals to nearest integer
        ...
        $query =" SELECT *  FROM nominal_roll LIMIT $endpoint, $total_records_per_page";
            ...
            <div class="small-box bg-primary">
              <div class="inner">
                <?php
                  ...
                  $allRecordsSql = "SELECT * FROM nominal_roll";
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <?php
                  ...
                  $completeStatusSql = "SELECT * FROM nominal_roll WHERE status = 'complete'";
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <?php
                ...
                $approvedStatusSql = "SELECT * FROM nominal_roll WHERE status = 'approved'";
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <?php
                ...
                $declinedStatusSql = "SELECT * FROM nominal_roll WHERE status = 'declined'";
...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">Stage 3-NOMINAL ROLL</h3>
  ...
  <div class="card-body p-0">
         ...
         while( $row = mysqli_fetch_array($countsql,MYSQLI_ASSOC)){
           ...
           ?>
            ...
            <tr>
                ...
                <td >
                <a href="stage3Action.php?file=<?php echo $feesfile?>"><?php echo $feesfile?> <i class="fa fa-download" aria-hidden="true"></i></a>
                ...
                <div class="input-group-prepend">
                    ...
                    <ul class="dropdown-menu">
                      <li class="dropdown-item"><a href="bsStage3.php?updateApproved=<?php echo $docId?>">Approved</a></li>
                      <li class="dropdown-item"><a href="bsStage3.php?updateDeclined=<?php echo $docId?>">Declined</a></li>
                ...
                <td class="project-actions text-right">
                    ...
                    <a class="btn btn-danger btn-sm" href="stage3Action.php?delete=<?php echo $docId?>">
    ...
    <div class="d-flex justify-content-center m-1">
         <a  class="btn  btn-sm btn-primary print-btn" href="stage3Details.php" id="login-btn" >Print</a>
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              ...
              <form id="quickForm" method="POST" action="bsStage1.php"  enctype="multipart/form-data">
                <div class="card-body">
                <p>Select an image less than MB with (.jpeg , .jpg, .png extension)</p>
