...
while($row= mysqli_fetch_assoc($result)){
  ...
  $image = $row['image'];
  $name = $surname." ".$fees_total;
}
if(isset($_POST['resubmit'])){
  // $id = $_POST['id'];
  // $studentName = $surname." ". $fees_total;
  $studentadmNo = $adm_no;
  $errors= array();
  $time = time();

  //adm letter
        $adm_letter_name = $_FILES['fees_file']['name'];
        $adm_letter_size =$_FILES['fees_file']['size'];
        $adm_letter_tmp =$_FILES['fees_file']['tmp_name'];
        $adm_letter_type=$_FILES['fees_file']['type'];
  ...
  //birth cert
    ...
    //empty file test
        if(empty($errors)==true){
            ...
            //for session
            $fees_file_session = "$image_dir/$adm_letter_image_name";
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Stage 3: Nominall Roll Resubmission</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">Stage 3: Nominall Roll Resubmission</h3>
        ...
        <div class="col-md-2"></div>
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"> Nominall Roll Resubmission</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <p>Select a document less than 4MB with (.pdf  extension)</p>
                  <div class="form-group">
                    <label for="profile" >BANK SLIP /CHEUQUE</label>
                      <input type="file" class="form-control " id="fees_file" name="fees_file"/>
                  </div>
                  <div class="form-group">
                    <label for="profile" >FEES TOTAL</label>
                      <input type="number" class="form-control " id="fees_total" name="fees_total" />
                  </div> 
                  <div class="form-group">
                    <label for="profile" >ACCOMMODATION</label>
                      <input type="number" class="form-control " id="accomodation" name="accomodation" />
                  </div>
