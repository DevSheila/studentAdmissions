...
if(isset($_GET['updateApproved'])){
  ...
  $sql= "UPDATE docs_collected SET status ='approved', date_submitted='$date'WHERE id = $id";
...
if(isset($_GET['updateDeclined'])){
  ...
  $sql= "UPDATE docs_collected SET status ='declined', date_submitted='$date'WHERE id = $id";
  if ($conn->query($sql) === TRUE) {
